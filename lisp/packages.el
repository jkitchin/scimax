...
(when (executable-find "jupyter")
  (use-package jupyter)
  (use-package scimax-jupyter :load-path load-dir))
...
(org-babel-load-file (expand-file-name "scimax-notebook.org" load-dir))
...
(use-package ox-manuscript
  :ensure nil
  :load-path (lambda () (expand-file-name "ox-manuscript" load-dir)))

(use-package org-show
  :ensure nil
  :load-path (lambda () (expand-file-name "org-show" load-dir)))
...
(let ((enable-local-variables nil))
  (org-babel-load-file (expand-file-name "scimax-editmarks.org" load-dir)))


(add-to-list 'Info-directory-list load-dir)
