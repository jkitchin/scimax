...
#+BEGIN_SRC emacs-lisp
 (define-key function-key-map (kbd "<print>") 'event-apply-super-modifier)
 (define-key function-key-map (kbd "<XF86Launch1>") 'event-apply-hyper-modifier)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
(add-to-list 'load-path "path/to/load-dir")
(require 'ob-ipython)
