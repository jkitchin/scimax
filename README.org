...
Another 2+ year update :) This release primarily revolves around making scimax brew-installable. See [[*homebrew]] fir details. This new method installs a command-line utility ~scimax~ that will start scimax for you.
