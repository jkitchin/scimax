...
2. Fractions: 1/4 to ¼
3. Auto-capitalization of weekdays and months, e.g. Monday and June.
4. Contraction expansion: cant to can not and can't  to can not
5. Commonly transposed letters in words: teh to the
6. Some convenience symbols: degC to °C and Ang to Å.
7. Some names like norskov to Nørskov.
...
When these are true they define regular abbreviations that expand.
