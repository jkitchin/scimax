...
scimax also defines some abbreviations that you can toggle on and off.

1. Auto-capitalization of weekdays and months, e.g. Monday and June.
   1. `scimax-toggle-month-abbrevs'
   2. `scimax-toggle-weekday-abbrevs'
2. Contraction expansion: cant to can not and can't  to can not
   1. `scimax-toggle-contraction-abbrevs'
3. Commonly transposed letters in words: teh to the
   1. `scimax-toggle-transposition-abbrevs'
4. Some common chemicals like co2 to CO_{2}, Some convenience symbols: degC to
   °C and Ang to Å, Some names like norskov to Nørskov.
   1. `scimax-toggle-chemical-formula-abbrevs'
...
#+NAME: bb21dabd-acb3-46bd-b8d8-ab174834fc37
#+BEGIN_SRC ipython :session :results output drawer 
import time
time.sleep(5)
#print(8)
...
#+RESULTS: bb21dabd-acb3-46bd-b8d8-ab174834fc37
:RESULTS:

[[file:ipython-inline-images/ob-ipython-f7122a4c0570fc3bf4ef580b97d5c1ae.png]]
:END:
...
- `scimax-org-eldoc' will generate documentation on elisp libraries in an org-mode format.
