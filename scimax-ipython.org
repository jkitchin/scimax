...
# output
: Length of t = 350
: x .dot. y = 1.3598389888491542

# image/png
[[file:obipy-resources/8f516355ee6cee60cbbb1e018eee2db1-131896qI1.png]]



# image/png
[[file:obipy-resources/8f516355ee6cee60cbbb1e018eee2db1-131896cSE.png]]
:END:
...
# image/png
[[file:obipy-resources/8f516355ee6cee60cbbb1e018eee2db1-131896pcK.png]]
...
# Out[4]:
# image/png
[[file:obipy-resources/8f516355ee6cee60cbbb1e018eee2db1-1318962mQ.png]]
:END:
...
Jupyter has some nice features like buttons to click on to run a block. We have something like that. The text in angle brackets in the comment below is clickable!

#+BEGIN_SRC ipython
# <run>  <restart and run>  <repl>
6 * 2
#+END_SRC
...
# Out[11]:
# image/png
[[file:obipy-resources/8f516355ee6cee60cbbb1e018eee2db1-131896DxW.png]]
:END:
...
g
  ...
  # image/svg
  [[file:obipy-resources/8f516355ee6cee60cbbb1e018eee2db1-131896Q7c.svg]]
  :END:
...
p
 ...
 # Out[10]:
 # image/png
 [[file:obipy-resources/8f516355ee6cee60cbbb1e018eee2db1-1318964vS.png]]

 # text/org
 [[/usr/local/google/home/kitchin/scimax/obipy-resources/bokeh-1vuy2xw6.html]]
 :END:
...
# image/png
[[file:obipy-resources/8f516355ee6cee60cbbb1e018eee2db1-131896e_1.png]]
...
# Out[9]:
#+BEGIN_EXPORT html
<div id="ae2fe59a-87ea-4502-9a03-83ee85c6a8b3" style="height: 300px; width:80%;"></div>
#+END_EXPORT
...
#+BEGIN_SRC javascript
        ...
        require(["//cdnjs.cloudflare.com/ajax/libs/flot/0.8.2/jquery.flot.min.js"], function() {
          ...
          console.log(line);
          $.plot("#ae2fe59a-87ea-4502-9a03-83ee85c6a8b3", [line]);
        });
