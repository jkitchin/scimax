...
(defcustom sem-menu-items
  '( ["Insert" sem-insert t]
     ["List editmarks" sem-editmark-display t]
     ["Clear editmark" sem-clear-editmark t]
     ["Next" sem-next-editmark t]
     ["Previous" sem-previous-editmark t]
     ["Jump to editmark" sem-jump-to-editmark t]
     ["Jump to visible" sem-jump-to-visible-editmark t]
     ["Accept" sem-accept-editmark t]
     ["Reject" sem-reject-editmark t]
     ["Insert hydra" sem-insert/body t]
     ["Action hydra" sem-action/body t])
  "List of editmark menu items.")

(easy-menu-define sem-menu scimax-mode-map "The editmarks"
  sem-menu-items)
